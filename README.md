...
`Peppermint`, `Peppermint-2023`, `MX`, `MX-23`, `Sparky`, `Sparky-7`  
...
```
#start vm
vagrant up [ Peppermint[-2023] | MX[-23] | Sparky[-7] ]

#login
vagrant ssh [ Peppermint[-2023] | MX[-23] | Sparky[-7] ]

#stop the vm
vagrant halt [ Peppermint[-2023] | MX[-23] | Sparky[-7] ]

#when you want to start with a clean install
vagrant destroy [ Peppermint[-2023] | MX[-23] | Sparky[-7] ]
vagrant up [ Peppermint[-2023] | MX[-23] | Sparky[-7] ]
```
